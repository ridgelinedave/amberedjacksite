...
**Full weekly specials rewrite (2026-07-07):** homepage `#specials` board rebuilt from the owner's Facebook message (forwarded via Randi → David) — the authoritative weekly board. New lineup: **Tue** Shrimp Fettuccine Alfredo, side salad + garlic bread, $15.99 supper / $12.99 lunch; **Wed** Lasagna $15.99 all day, side salad + garlic bread (kept the standing "Kids eat free every Wednesday 4pm" callout — owner's msg didn't restate it but it's a permanent promo); **Thu** Salisbury Steak & Gravy $15.99 all day, mashed potatoes + corn on the cob + roll; **Fri** lunch Philly Cheesesteak Bowl $10.99 + Small One-Topping Pizza $9.99, from 4pm New York Strip (baked potato/side salad/roll, **no price yet** — owner hasn't set it, shown as "ask your server"); **Sat** Boyd's Seafood Platter $20.99 all day (pick 3, choice of potato/hushpuppies/slaw). Two items flagged to David for confirmation: Tue lunch $12.99 (from whiteboard, not the text) and Fri NY-strip price. Removed prior week's items (BBQ Sirloin Tipper, Wed apps/chicken salad, Thu BBQ Chicken Plate, Fri BLT Sub + Hamburger Steak). Also earlier this session: removed the leftover Google-rating `TODO(owner)` HTML comment on index.html (4.4 already confirmed & rendered). Then per David: simplified Tue to a flat $15.99 (dropped supper/lunch note).

**Weekly specials update — week of 2026-07-13 (from owner msg):** **Tue** Large 2-Topping Pizza with 12 boneless wings $25.99 all day; **Wed** Lasagna $15.99 all day (unchanged; kids-free callout kept); **Thu** House-Cooked Brisket & Hushpuppies $15.99, choose 2 sides (fried potatoes/coleslaw/okra/baked beans/fried squash/corn on the cob); **Fri** lunch Philly Cheesesteak Bowl **$11.99** (up from $10.99) + Small One-Topping Pizza $9.99, from 4pm Pan-Seared Salmon $18.99 (baked potato or fries + a side/side salad); **Sat** Boyd's Seafood Platter $20.99 (pick 3; baked potato or fries, coleslaw, hushpuppies). Replaced last week's Tue shrimp fettuccine, Thu Salisbury steak, and Fri NY strip. No open price questions this week.

**Weekly specials update — week of 2026-07-21 (from owner text):** **Tue** Large 2-Topping Pizza $25.99 all day — now with **two side salads** + 12 boneless wings (added the salads); **Wed** Lasagna $15.99 all day, side salad + **sourdough** garlic bread (kids-free callout kept); **Thu** swapped brisket → **Country Fried Steak & Gravy $15.99** all day, house-made mashed potatoes + green beans + homemade biscuits; **Fri** lunch swapped → **Smoked Brisket Philly Bowl $13.99** (grilled peppers/onions/mushrooms over fried potatoes, oven-baked w/ mozzarella), from 4pm swapped → **12 oz New York Strip $24.99** (baked potato, grilled asparagus, sourdough rolls; add house shrimp +$5); **Sat** left as **Boyd's Seafood Platter $20.99** — owner said she'd **send Saturday board pics separately** (not yet received). Two items flagged to David: (1) Fri lunch — owner's text listed ONLY the brisket philly bowl, so last week's Small One-Topping Pizza $9.99 was **dropped**; confirm if it should stay. (2) Saturday board pics still pending. Verified no mobile h-scroll after edit. **Resolved same session:** David confirmed drop the Fri-lunch pizza (kept dropped) and keep Boyd's on Saturday (they always do Boyd's Sat). Then a **second push** added an **"All Week" row** at the bottom of the board (new day-label "All Week", same day-row classes): **Appetizer** Jalapeño Poppers $7.99; **Sides · $3.99 each** — fried green tomatoes, fried squash, zucchini fries, fried potatoes, fried okra (owner's board pic; David's msg typo'd "Fried Okay" → corrected to Fried Okra). Both pushes live via git → Cloudflare.
